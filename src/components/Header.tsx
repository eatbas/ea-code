...
/** Top navigation bar with app title, workspace path, and settings toggle. */
export function Header({ workspace, showSettings, onToggleSettings }: HeaderProps): ReactNode {
  return (
