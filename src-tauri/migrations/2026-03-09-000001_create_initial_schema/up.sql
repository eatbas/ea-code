...
CREATE TABLE settings (
    ...
    copilot_path                    TEXT    NOT NULL DEFAULT 'gh',
    ...
    codex_model                     TEXT    NOT NULL DEFAULT 'codex-5.3',
    ...
    copilot_model                   TEXT    NOT NULL DEFAULT 'default',
    ...
    reviewer_model                  TEXT    NOT NULL DEFAULT 'codex-5.3',
    fixer_model                     TEXT    NOT NULL DEFAULT 'sonnet',
    final_judge_model               TEXT    NOT NULL DEFAULT 'codex-5.3',
    executive_summary_agent         TEXT    NOT NULL DEFAULT 'codex',
    executive_summary_model         TEXT    NOT NULL DEFAULT 'codex-5.3',
