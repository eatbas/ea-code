...
ALTER TABLE settings ADD COLUMN reviewer_model TEXT NOT NULL DEFAULT 'o4-mini';
ALTER TABLE settings ADD COLUMN fixer_model TEXT NOT NULL DEFAULT 'sonnet';
ALTER TABLE settings ADD COLUMN final_judge_model TEXT NOT NULL DEFAULT 'o4-mini';
